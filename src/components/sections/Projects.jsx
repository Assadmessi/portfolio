                  ...
                  <div className="relative">
                    {featuredItem.p?.image ? (
                      <img
                        ...
                        className="h-56 sm:h-72 lg:h-80 w-full object-cover group-hover:scale-[1.02] transition duration-500"
                      />
                    ) : (
                      <div className="h-56 sm:h-72 lg:h-80 w-full bg-slate-100 dark:bg-white/10" />
                    )}
